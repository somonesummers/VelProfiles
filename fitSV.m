function [varargout] = fitSV(x, z, t, sMax, vMax, dr)
    % [sv, m2] = fitVelocity(x, z, t, s, vMax, sMax, dr) solves for velocity profile
    ...
    % fits. 
    % [sv, m2, F] = fitVelocity(x, z, t, s, vMax, sMax, dr) also returns the
    % score of the Fits
    nOutputs = nargout;
